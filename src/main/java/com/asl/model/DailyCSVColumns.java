...
public class DailyCSVColumns {
	...
	public DailyCSVColumns(CSVRecord csvRecord, long totalColumnFound) {
	...
	public void validaeColumns(DailyCSVColumns mcc, StringBuilder errorReasons, int rowNumber) {
	...
	public List<String> getErrorRecord(DailyCSVColumns mcc, StringBuilder errorReasons){
	...
	public List<String> getSuccessRecord(DailyCSVColumns mcc){
		List<String> successRecord = new ArrayList<>();
		getRecord(successRecord, mcc);
		return successRecord;
	}

	private void getRecord(List<String> record, DailyCSVColumns mcc) {
