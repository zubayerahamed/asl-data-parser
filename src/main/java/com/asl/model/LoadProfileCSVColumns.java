...
public class LoadProfileCSVColumns {
	...
	public void validaeColumns(LoadProfileCSVColumns mcc, StringBuilder errorReasons, int rowNumber) {
	...
	public List<String> getErrorRecord(LoadProfileCSVColumns mcc, StringBuilder errorReasons){
	...
	public List<String> getSuccessRecord(LoadProfileCSVColumns mcc){
		List<String> successRecord = new ArrayList<>();
		getRecord(successRecord, mcc);
		return successRecord;
	}

	private void getRecord(List<String> record, LoadProfileCSVColumns mcc) {
